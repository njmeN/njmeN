...
import ir.dunijet.wikipedia.activity.ItemEvents
import ir.dunijet.wikipedia.activity.TrendAdapter
import ir.dunijet.wikipedia.adapter.ExploreAdapter
import ir.dunijet.wikipedia.data.ItemPost
import ir.dunijet.wikipedia.databinding.ActivityMain2Binding
import ir.dunijet.wikipedia.databinding.FragmentExploreBinding
import ir.dunijet.wikipedia.databinding.FragmentTrendBinding
...
class trendFragment : Fragment(),ItemEvents {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val trendAdater= TrendAdapter(dataTrend,this)
        binding.recyclerTrend.adapter=trendAdater
        binding.recyclerTrend.layoutManager=LinearLayoutManager(context,RecyclerView.VERTICAL,false)


    }

    override fun onItemClicked(itmePost: ItemPost) {
       val intent = Intent(activity,ActivityMain2Binding::class.java)
        intent.putExtra(SEND_DATA_TO_SECOND_ACTIVITY,itmePost)
